...
namespace HallovEngine.Platform.OpenGL
{
    ...
    {
        public sealed class GLTexture : Rendering.Texture
        {
            public readonly int Handle;

            public static GLTexture LoadFromFile(string path)
            {
                // Generate handle
            ...
            public override void Use(int unit)
            {
